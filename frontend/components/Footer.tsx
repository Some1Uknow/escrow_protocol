      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-8 py-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <Link href="/" className="flex items-center gap-2">
            <div className="size-6 bg-[#6a25f4] rounded-full flex items-center justify-center">
              <Lock className="w-3 h-3 text-white" />
            </div>
            <span className="font-bold text-lg text-white">EscrowProtocol</span>
          </Link>
          ...
          <div className="flex flex-wrap justify-center gap-8 text-sm text-gray-400">
            <a
              href="#"
              className="hover:text-[#6a25f4] transition-colors"
            >
              Privacy Policy
            </a>
            <a
        ...
        <div className="text-center mt-8 text-xs text-gray-600">
          © {new Date().getFullYear()} EscrowProtocol. All rights reserved.
        </div>
      </div>
    </footer>
  );
